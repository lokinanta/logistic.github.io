...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    <a href="./in_port.php" class="brand-link">
        <img src="../../dist/img/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
        <span class="brand-text font-weight-light">PORT OPERATIONAL</span>
    </a>
            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
               ...
               with font-awesome or any other icon font library -->
                ...
                <li class="nav-item <?= $shp; ?>">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="./list_shipment.php" class="nav-link <?= $sb_list_shipment; ?> ">
                                <i class="fas fa-list-ul nav-icon"></i>
                                <p>List Shipment</p>
                            </a>
                        </li>
                ...
                <li class="nav-item">
                    <a href="../../logout.php" class="nav-link bg-red">
